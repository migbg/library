...
<body>
    ...
    <div class="container">
        <div class="container-row" style="align-items: center; gap: 20px;">
            <?php 
                if ($update == "yes") echo "<a href='book.php?id=" .  htmlspecialchars($book['id']) . "'><button class='back'><i class='bi bi-arrow-left-circle icon'></i> Go back </button></a>";
                else echo "<a href='index.php'><button class='back'><i class='bi bi-arrow-left-circle icon'></i> Go back </button></a>";
            ?>
        ...
        <form action="book_actions.php<?php if ($update == "yes") echo "?id=" . htmlspecialchars($book['id']) ?>" method="post" enctype="multipart/form-data">
            <div class="container-row">
                <label for="title"><i class="bi bi-alphabet-uppercase form-icon"></i> Title* </label>
            ...
            <div class="container-row">
                <label for="description"><i class="bi bi-body-text form-icon"></i> Description </label>
            ...
            <div class="container-row">
                <label for="author"><i class="bi bi-file-person-fill form-icon"></i> Author* </label>
            ...
            <div class="container-row">
                <label for="url"><i class="bi bi-box-arrow-up-right form-icon"></i> URL </label>
            ...
            <div class="container-row">
                <label for="year"><i class="bi bi-calendar-date form-icon"></i> Year </label>
            ...
            <div class="container-row">
                <label for="userfile"><i class="bi bi-file-image form-icon"></i> Cover </label>
                <input type="file" name="userfile" id="userfile">
            </div>
            <b><i class="bi bi-tag-fill form-icon"></i> Categories </b>
            <hr>
            <div class="scroll">
                <?php
            ...
            <?php
                if ($update == "yes"){
                    ...
                    echo "<span><i class='bi bi-x-octagon icon'></i> Reset cover </span>";
            ...
            ?>
            <button name="action" type="submit" style="width: 100%;" <?php if ($update == "yes") echo "value='update'" ?>></i><?php echo $update == "yes" ? "<i class='bi bi-arrow-clockwise icon icon'></i> Update" : "<i class='bi bi-journal-plus icon'></i> Add" ?></button>
        </form>
    </div>
</body>
</html>

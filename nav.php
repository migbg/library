...
<nav>
    <div class="container-nav">
        ...
        <div class="container-nav-buttons">
            ...
            <a href="book_form.php"><button type="button"><i class="bi bi-plus-circle icon"></i> Add book </button></a>
            <details>
                ...
                <div>
                    <a href="profile.php"><button class="back" type="button"><i class="bi bi-person-circle icon"></i> View profile </button></a>
                    <a href="logout.php"><button class="delete" type="button"><i class="bi bi-box-arrow-left icon"></i> Sign out </button></a>  
                </div>
            </details>
        </div>
    </div>
